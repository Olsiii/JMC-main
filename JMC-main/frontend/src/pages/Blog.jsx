    ...
    <div>
      ...
      <section className="py-20 md:py-32 bg-[#F8F5F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm uppercase tracking-widest text-[#D4AF37] mb-4">From Our Team</p>
          ...
          {filtered.length === 0 && (
            <p className="text-center text-[#9A9A9A] mt-12">No articles in this category yet.</p>
          )}
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Our articles are for informational purposes. For advice specific to your situation,
